...
На вход хелпера поступает словарь с результатами опроса устройства. В результате своей работы функция так
же должна вернуть словарь, что бы отдать ответ пользователю.
