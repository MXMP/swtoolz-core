...
# swL2PortInfoMediumType .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.2
MediumType = ({
                  '1': 'copper',
                  '2': 'fiber',
              },)

# swL2PortInfoLinkStatus .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.5
ActualStatus = ({
                    '1': 'other',
                    '2': 'linkup',
                    '3': 'linkdown',
...
# swL2PortInfoNwayStatus .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.6
ActualSpeed = ({
                   '0': 'other',
                   '1': 'empty',
                   '2': 'linkdown',
...
# swL2PortCtrlAdminState .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.4
AdminStatus = ({
                   '1': 'other',
                   '2': 'disabled',
                   '3': 'enabled',
...
# swL2PortCtrlNwayState .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.5
AdminSpeed = ({
                  '1': 'other',
                  '2': 'auto',
                  '3': '10M-Half',
...
# swL2PortCtrlFlowCtrlState .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.6
AdminFlow = ({
                 '1': 'other',
                 '2': 'disabled',
                 '3': 'enabled',
...
# swL2PortInfoType .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.4
PortType = ({
                '0': 'none',
                '2': '100Base-T',
                '3': '100Base-X',
...
walk_PortIndex = {
    # PortIndex   .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1  swL2PortInfoPortIndex
    'PortIndex': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1',
}

get_PortIndex = {
    # PortIndex       .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1  swL2PortInfoPortIndex
    'PortIndex..1':  '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.1.1',
    'PortIndex..2':  '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.2.1',
    'PortIndex..3':  '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.3.1',
    'PortIndex..4':  '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.4.1',
    'PortIndex..5':  '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.5.1',
    'PortIndex..6':  '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.6.1',
    'PortIndex..7':  '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.7.1',
    'PortIndex..8':  '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.8.1',
    'PortIndex..9':  '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.9.1',
    'PortIndex..10': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.10.1',
    'PortIndex..11': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.11.1',
    'PortIndex..12': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.12.1',
    'PortIndex..13': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.13.1',
    'PortIndex..14': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.14.1',
    'PortIndex..15': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.15.1',
    'PortIndex..16': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.16.1',
    'PortIndex..17': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.17.2',
    'PortIndex..18': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.18.2',
    'PortIndex..19': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.19.2',
    'PortIndex..20': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.1.20.2',
}
...
get_SinglePort = {
    # MediumType      .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.2 swL2PortInfoMediumType
    'MediumType..c': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.2.%s.1',
    'MediumType..f': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.2.%s.2',
    # ActualStatus      .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.5 swL2PortInfoLinkStatus
    'ActualStatus..c': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.5.%s.1',
    'ActualStatus..f': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.5.%s.2',
    # ActualSpeed      .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.6 swL2PortInfoNwayStatus
    'ActualSpeed..c': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.6.%s.1',
    'ActualSpeed..f': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.6.%s.2',
    # AdminStatus      .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.4 swL2PortCtrlAdminState
    'AdminStatus..c': '.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.4.%s.1',
    'AdminStatus..f': '.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.4.%s.2',
    # AdminSpeed      .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.5 swL2PortCtrlNwayState
    'AdminSpeed..c': '.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.5.%s.1',
    'AdminSpeed..f': '.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.5.%s.2',
    # AdminFlow      .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.6 swL2PortCtrlFlowCtrlState
    'AdminFlow..c': '.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.6.%s.1',
    'AdminFlow..f': '.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.6.%s.2',
    # PortType      .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.4 swL2PortInfoType
    'PortType..c': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.4.%s.1',
    'PortType..f': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.4.%s.2',
...
walk_AllPorts = {
    # MediumType   .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.2 swL2PortInfoMediumType
    'MediumType': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.2',
    # ActualStatus   .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.5 swL2PortInfoLinkStatus
    'ActualStatus': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.5',
    # ActualSpeed   .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.6 swL2PortInfoNwayStatus
    'ActualSpeed': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.6',
    # AdminStatus   .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.4 swL2PortCtrlAdminState
    'AdminStatus': '.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.4',
    # AdminSpeed   .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.5 swL2PortCtrlNwayState
    'AdminSpeed': '.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.5',
    # AdminFlow   .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.6 swL2PortCtrlFlowCtrlState
    'AdminFlow': '.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.6',
    # PortType   .1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.4 swL2PortInfoType
    'PortType': '.1.3.6.1.4.1.171.10.133.7.2.2.3.1.1.4',
    # PortDescr   .1.3.6.1.2.1.31.1.1.1.18 ifAlias
...
set_AdminStatus = [
    # .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.4 swL2PortCtrlAdminState
    ['.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.4.%s', '1', '%s', 'INTEGER'],
]

set_AdminSpeed = [
    # .1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.5 swL2PortCtrlNwayState
    ['.1.3.6.1.4.1.171.10.133.7.2.2.3.2.1.5.%s', '1', '%s', 'INTEGER'],
]
