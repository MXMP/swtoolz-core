...
set_AdminStatus = [
#     .1.3.6.1.4.1.171.11.63.3.2.2.2.1.3				swL2PortCtrlAdminState
    ['.1.3.6.1.4.1.171.11.63.3.2.2.2.1.3.%s', '100', '%s', 'INTEGER'],
    ]

set_AdminSpeed = [
#     .1.3.6.1.4.1.171.11.63.3.2.2.2.1.4				swL2PortCtrlNwayState
    ['.1.3.6.1.4.1.171.11.63.3.2.2.2.1.4.%s', '100', '%s', 'INTEGER'],
    ]
